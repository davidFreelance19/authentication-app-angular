...
// node_modules/.pnpm/ngx-sonner@0.4.1_@angular+common@17.3.3_@angular+core@17.3.3_rxjs@7.8.1_zone.js@0.14.4__rxjs@_7kuoylajad3bwff6ushaq6lmxy/node_modules/ngx-sonner/fesm2022/ngx-sonner.mjs
...
var _ToastComponent = class _ToastComponent {
  constructor() {
    ...
    effect(() => {
      ...
      untracked(() => this.offset.set(Math.round(heightIndex * GAP$1 + toastsHeightBefore)));
    });
    effect(() => {
...
_ToastComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function ToastComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵadvance(2);
      ɵɵconditional(2, ctx.toast().dismissable && ctx.closeButton() && !ctx.toast().component ? 2 : -1);
      ɵɵadvance();
